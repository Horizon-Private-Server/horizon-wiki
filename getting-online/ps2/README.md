...
2. Insert the USB drive into your computer. Format it to FAT32 and MBR partition scheme. Depending on your computer, you may need to download a progrma like [Rufus](https://rufus.ie/en/) in order to format the USB correctly. Refer to the image at the end of this section for correct formatting settings in Rufus.  
