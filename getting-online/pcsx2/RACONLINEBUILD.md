...
3. Install Nmap using the “nmap-7.91-setup.exe” file in the folder, or get the latest version from [this link](https://nmap.org/download). This has to be done to allow for online play.
