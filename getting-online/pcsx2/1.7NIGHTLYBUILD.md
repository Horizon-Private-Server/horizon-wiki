...
*This guide is by DeathBySnowman, last revised 17 May 2022.*
...
1. ***Install the latest version of Nmap from [this link](https://nmap.org/download) (find the "Latest stable release self-installer: nmap-X.XX-setup.exe" and download it).*** This has to be done in order to allow for online play.
...
5. Go to the Config menu → General Settings, then select the BIOS tab at the top left.
