...
This is likely because you did not check the "Enabled" box in PCSX2's Network and HDD settings. For PCAP connections, you may also need to install Nmap as explained in the [previous FAQ section](/getting-online/pcsx2/1.7Nightly-Feb2023.md#alternate-network-setup-nmappcap).  
