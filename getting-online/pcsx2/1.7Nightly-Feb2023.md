...
12. This step only applies if you have a PAL or NTSC-J version of the game/ISO. It can be ignored if you have an NTSC-U/C version of the game/ISO. For PAL/NTSC-J players:
   a) Download the files [here (R&C3)](/assets/cheats/17125698.pnach) and [here (Gladiator)](/assets/cheats/D697D204.pnach) (visit the link, right click the "Raw" button near the top right, then "Save As").
