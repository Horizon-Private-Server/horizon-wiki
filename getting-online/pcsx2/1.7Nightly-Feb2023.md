...
If NEITHER the Sockets/Auto or Nmap/PCAP methods are working, there is a third network setup you can try. **This setup may work for Horizon-supported titles only.**  
