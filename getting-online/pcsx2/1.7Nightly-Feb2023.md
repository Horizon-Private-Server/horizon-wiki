...
### QX: Why do I enter `192.0.2.1` for the Primary DNS address during network setup and not one of the DNS addresses listed in the `#how-to-play` channel of the Horizon Discord server?
...
### Q5: I am using Wi-Fi. I read Q1-Q3 and tried everything and it still isn't connecting! Help?
...
Q8: I am still having issues connecting to the server!
