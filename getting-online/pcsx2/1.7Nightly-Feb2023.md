...
### Configure PCSX2 BIOS, emulation, and graphics settings
...
![img](/assets/pcsx2/Guide-2023Feb/pcsx2-2023Feb-settings_network_ethernet.png)

10. Download the [internal DNS file here](/assets/cheats/pcsx2_template_hosts.ini) (visit the link, right click the "Raw" button near the top right, then "Save As") and save it into your PCSX2 folder. Still in Settings → Network & HDD, click on the Internal DNS tab and click "Import". Select the file you downloaded and click OK. A pop-up window should appear indicating that DNS Hosts were imported successfully. Click OK and the window should show a list of DNS addresses, similar to the image below.

![img](/assets/pcsx2/Guide-2023Feb/pcsx2-2023Feb-settings_network_internalDNS.png)
