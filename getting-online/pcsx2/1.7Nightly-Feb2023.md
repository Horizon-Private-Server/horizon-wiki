...
### Configure PCSX2 Network Settings (Sockets/Auto method)
<details>
<summary>Click here to expand/collapse details.</summary>  
...
14. Save your profile and log in. That's it!  
</details>
...
- For Steam Deck, you MUST set up using the Ethernet Device Type as "Sockets" and the Ethernet Device to "Auto". The Nmap/PCAP method will not work.  
...
For some titles, the Sockets/Auto setup shown above or Nmap/PCAP setup shown below and either Cristian's or 1UP/K3rber0s' DNS will work without any further steps. For others, extra steps are required. Requirements can vary on a game-by-game basis. Here are some helpful resources for checking the requirements of each title:  
...
If the Sockets network setup detailed above isn't working, you may want to try this alternate setup.  
...
### Alternate Network Setup (Sockets/Auto method with internal DNS)
<details>
<summary>Click here to expand/collapse details.</summary>  
   
If NEITHER the Sockets/Auto or Nmap/PCAP methods are working, there is one other setup you can try. **This setup may work for Horizon-supported titles only.**  
...
#### Some other things that you can try:  
   - If the Nmap/PCAP network setup is not working, try the Sockets network setup detailed in the previous FAQ - and vice versa.  
