...
If you find that this guide has become out of date, please let a Horizon staff member know and we will try to get it updated when we have time.  
Set up as follows:

### Download and Install Nmap
1. Visit [this link](https://nmap.org/download) and find the "Latest stable release" for your operating system. Download and install it. **This has to be done in order to play any PS2 game online in PCSX2.**
...
13. Start the game, navigate to Online Play, and click Square to access the network setup tool. Click "Add Setting" and run through the steps to create a new network configuration.
   ...
   d) On the screen where you enter the DNS server address, enter the DNS: `192.0.2.1` for the 'Primary DNS', matching what is pointed out by the yellow arrow above (click here for why). The 'Secondary DNS' should be left blank.
