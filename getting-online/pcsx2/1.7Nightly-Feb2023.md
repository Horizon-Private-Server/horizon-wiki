...
This is likely because you did not check the "Enabled" Ethernet setting. Revisit and complete the [PCSX2 network setup section above](/getting-online/pcsx2/1.7Nightly-Feb2023.md#configure-pcsx2-network-settings-socketshorizon). For PCAP connections, you may also need to install Nmap as explained in the [previous FAQ section](/getting-online/pcsx2/1.7Nightly-Feb2023.md#alternate-network-setup-nmappcap).  
