...
If you plan on playing other PS2 titles online in addition to Horizon-supported titles, you may want to use this alternate network setup. It is more complex than the [Sockets/Horizon setup detailed above](/getting-online/pcsx2/1.7Nightly-Feb2023.md#configure-pcsx2-network-settings), but it should still work for Horizon-supported titles and will likely work for a wider variety of titles overall.
