...
- [Fixing Delay with Nvidia Graphics Cards](/getting-online/pcsx2/1.7Nightly-Feb2023.md#fixing-delay-with-nvidia-graphics-cards)
...
2. In the application, find the "Manage 3D Settings" section and click on the "Add" button next to the "Select a program to customize" drop down menu.  
