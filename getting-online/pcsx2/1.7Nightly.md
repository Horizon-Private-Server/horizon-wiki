...
- [16:10 Textures for UYA/R&C 3 and Deadlocked](https://drive.google.com/drive/folders/1yOrM6TDuUvbYosSMTlPXrsbG3ciwzzjp?usp=sharing) - @bubblegum3390 created these patches and textures for Steam Deck and other 16:10 displays. These are only recommended for 16:10 displays and will result in a squashed picture on normal 16:9 monitors. To use the patches, see the readme .txt file in the download.
