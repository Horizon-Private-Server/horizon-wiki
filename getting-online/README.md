...
- Ratchet: Deadlocked (Ratchet: Gladiator):
  - NTSC-U/C (North America)
  - PAL (Europe)*
- Unfortunately, there is _NOT_ crossplay between the PS2 and PS3 versions of either game. However, the PS3 version online servers are also playable. Check the `#other-servers` channel in the [Horizon Discord server](https://rac-horizon.com/discord) for details. Also, if you have a backward compatible PS3 you can play the PS2 games online.
...
*Last updated 2025-08-05. If these DNS do not work, please contact us or look for the latest DNS in the `#how-to-play` channel in the [Horizon Discord server](https://rac-horizon.com/discord).*
