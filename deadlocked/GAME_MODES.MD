...
The attacking team is given a bomb (Red Weapon Pack) at the start of each round, this bomb can only be carried by a single, selected player. Victory conditions are as follows:
