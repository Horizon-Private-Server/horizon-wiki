...
The Horizon server enables users to play on custom maps. Please note: custom maps currently work for the NTSC-U/C (North American) version of the game only.
